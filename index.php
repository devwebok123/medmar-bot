    ...
    if($userChatId) {
        ...
        if(strtolower($userMessage) == "contacts") {           
            ...
            $parameters = array(
                ...
                "text" => $text,
                "parseMode" => "html",
                "reply_markup" => '{"keyboard": [["Contacts"],["Ischia - Pozzuoli"],["Ischia - Napoli"],["Ischia - Procida"],["Casamicciola - Pozzuoli"],["Casamicciola - Napoli"],["Pozzuoli - Ischia"],["Pozzuoli - Casamicciola"],["Pozzuoli - Procida"],["Napoli - Ischia"],["Napoli- Casamicciola"],["Pozzuoli - Ischia via Procida"],["Procida - Pozzuoli"],["Procida - Napoli"],["Ischia PDF"],["Procida PDF"],["Condividi Bot"]], "one_time_keyboard": false}'
            );               
            ...
            send("sendDocument", $parameters);
        } else if (strtolower($userMessage) == "condividi bot") {
            $text = "Condividi questo link con i tuoi amici: https://t.me/MedmarNaviBot";
            $parameters = array(
                "chat_id" => $userChatId,
                "text" => $text,
                "parseMode" => "html",
